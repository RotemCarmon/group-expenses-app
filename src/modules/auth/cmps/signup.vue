<template>
  <section class="login-signup-container container" @keyup.enter="doSignup">
    ...
    <label class="form-row">
      <span>Username </span>
      <input type="text" v-model="creds.username" class="form-input" />
    ...
    <label class="form-row">
      ...
      <input type="password" v-model="passwordConfirm" class="form-input" />
      <p class="error" v-show="passwordConfirmError">
        {{ passwordConfirmError }}
      </p>
    </label>

    <button @click="doSignup" class="btn dark buttom-btn">
      Create Account
    </button>
